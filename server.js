...
const db = new sqlite3.Database(dbPath, (err) => {
    ...
    else console.log('Connected to OP80 SQLite database.');
});
...
<body>
    ...
    <div class="container" id="app">
        ...
        <div id="dashboard-section" class="hidden dashboard-box">
            ...
            <div id="admin-panel" class="hidden" style="background: rgba(202, 138, 4, 0.12); border: 1px solid rgba(202, 138, 4, 0.4); padding: 16px; border-radius: 14px;">
                ...
                <p id="admin-response" style="font-size: 12px; color: #fde047; margin-top: 10px; font-weight: 600;"></p>
            </div>
            ...
            <div>
                ...
                <div style="display: flex; gap: 10px; align-items: center;">
                    ...
                    <button onclick="document.getElementById('chat-foto').click()" class="btn-action" style="background: #475569; box-shadow: none;" title="Send Photo">📷</button>
    ...
    <script>
        // Animación robusta de Ciber-Números Cayendo en Rojo Neón (Estilo Matrix Dinámico)
